package kz.coreproject.data.repository.error_handler

import android.app.Application
import com.google.gson.Gson
import coreproject.app.R
import kz.coreproject.data.models.network.Resource
import kz.coreproject.data.models.network.error.ApiError
import kz.coreproject.data.preferences.Preferences
import kz.coreproject.network.exceptions.ApiException
import kz.coreproject.network.exceptions.ConnectionTimeOutException
import kz.coreproject.network.exceptions.UnauthorizedException
import kz.coreproject.network.exceptions.UnknownException
