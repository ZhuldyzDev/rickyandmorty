package kz.bcc.school.utils.mask

import android.widget.EditText
import com.redmadrobot.inputmask.MaskedTextChangedListener
import com.redmadrobot.inputmask.helper.Mask
import com.redmadrobot.inputmask.model.CaretString
import kz.bcc.school.data.enums.app.MaskTypeEnums
import kz.bcc.school.utils.Logger
        ...
        return MaskedTextChangedListener(
            ...
            object : MaskedTextChangedListener.ValueListener {
                override fun onTextChanged(
                    ...
                    kz.bcc.school.utils.Logger.e(javaClass, extractedValue)
                    kz.bcc.school.utils.Logger.e(javaClass, maskFilled.toString())
                }
            }
        )
    }
